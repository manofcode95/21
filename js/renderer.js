...
function renderTutorialScene2() {
    ...
    // Arrow
    arrow = new Sprite(Texture.fromImage("./images/arrow.png"));
    arrow.scale.set(0.2);
    ...
    // Title Type Text
    titleTypeText = new Sprite(Texture.fromImage("./images/titletype.png"));
    titleTypeText.scale.set(0.16);
...
function renderIntroduceScene() {
    ...
    // Introduce text
    nextBtn1 = new Sprite(Texture.fromImage("./images/start-btn-3.png"));
